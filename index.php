...
<div class="collapse navbar-collapse" id="myMenu">
    <ul class="navbar-nav pl-5 custom-nav">
        ...
        <li class="nav-item"><a href="#Registration" class="nav-link">Registratoin</a></li>
            ...
            <div class="col-lg-3 col-sm-6">
              ...
              <div class="card shadow-lg mb-2">
                <div class="card-body text-center">
                  ...
                  <h4 class="card-title">Pushkar Raj</h4>
                  <p class="card-text">Itaque illo explicabo voluptatum, saepe libero rerum, ad
                    ducimus voluptas
                    nesciunt debitis numquam.</p>
                </div>
            ...
            <div class="col-lg-3 col-sm-6">
              ...
              <div class="card shadow-lg mb-2">
                <div class="card-body text-center">
                  ...
                  <h4 class="card-title">Arvind Yadav</h4>
                  <p class="card-text">Itaque illo explicabo voluptatum, saepe libero rerum, ad
                    ducimus voluptas
                    nesciunt debitis numquam.</p>
                </div>
  ...
  <div class="container" id="Contact">
        ...
        <!-- End Contact Us 1st Column-->
          ...
          <div class="col-md-4 text-center">
            ...
            Shrikant Technology Pvt Ltd, <br>
            Sec II, Rajendra Nagar <br>
            Ghaziabad - 201005 <br>
            Phone:9716082341 <br>
            <a href="#" target="_blank">http://ramnaumi.xyz/</a> <br>
            ...
            Delhi - 110096 <br>
            Phone: 7011285756 <br>
            <a href="#" target="_blank">http://khansingh.xyz/Car_Rental/</a> <br>
        ...
        <div class="container">
          ...
          <div class="row py-3">
            ...
            <div class="col-md-6 text-right">
              ...
              <small> Designed by <span class="text-danger">Shrikant Yadav </span>&copy; 2019.
              </small>
