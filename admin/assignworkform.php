...
if(isset($_SESSION['is_adminlogin'])){
 ...
 if(isset($_REQUEST['assign'])){
  ...
  if(($_REQUEST['requester_id'] == "") || ($_REQUEST['request_info'] == "") || ($_REQUEST['requestdesc'] == "")
   ...
   $msg = '<div class="alert alert-warning col-sm-6 ml-5 mt-2" role="alert"> Fill All Fileds </div>';
    ...
    $sql = "INSERT INTO assignwork_tb (requester_id, request_info, request_desc, requester_name, requester_add1,
...
<div class="col-sm-5 mt-5 jumbotron">
  ...
  <form action="" method="POST">
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="request_id" name="requester_id" value="<?php if(isset($row['requester_id'])) {echo $row['requester_id']; }?>"
        readonly>
    </div>
    <div class="form-group">
