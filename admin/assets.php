<?php 
    ...
    echo '<table class="table">
     ...
     while($row = $result->fetch_assoc()){
      echo '<tr>';
       ...
       echo '<td><form action="editproduct.php" method="POST" class="d-inline"> 
       ...
       <input type="hidden" name="id" value='. $row["pid"] .'>
       <button type="submit" class="btn btn-warning" name="issue" value="View">
       <i class="fas fa-handshake"></i></button></form></td>
      </tr>';
     }
   ...
   <div class="float-right"><a class="btn btn-danger" href="addproduct.php"><i class="fas fa-plus fa-2x"></i></a>
   </div>
   </div><!--End Container -->
