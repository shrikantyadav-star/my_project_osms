<?php 
    ...
    // $sql = "SELECT max(requester_id) FROM assignwork_tb";
    // $result = $conn->query($sql);
    ...
    // Another way to write this type of query
    ...
    $totaltech = $result->num_rows;
 ?>
        <div class="col-sm-9 col-md-10"><!-- Start Dashboard Area Column 2nd -->
                ...
                <div class="mx-5 mt-5 text-center">
                    <p class="bg-dark text-white p-2">List of Parameters</p>
                    <?php
        ...
        </div><!--End Dashboard Area Column 2nd -->
