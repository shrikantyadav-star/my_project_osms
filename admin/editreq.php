...
session_start();
 ...
 if(isset($_REQUEST['requpdate'])){
  ...
  if(($_REQUEST['user_id'] == "") || ($_REQUEST['r_name'] == "") || ($_REQUEST['r_email'] == "")){
  ...
  $sql = "UPDATE requesterlogin_tb SET user_id = '$rid', r_name = '$rname', r_email = '$remail' WHERE user_id = '$rid'";
...
<div class="col-sm-6 mt-5  mx-3 jumbotron">
 ...
 if(isset($_REQUEST['view'])){
  $sql = "SELECT * FROM requesterlogin_tb WHERE user_id = {$_REQUEST['id']}";
